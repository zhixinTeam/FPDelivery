...
uses
  UFormWait, Forms, USysLoger, USysDB, MIT_Service_Intf, UMITConst;
...
begin
  Result := gSysParam.FGPWSURL;//gSysParam.FWechatURL;
end;

initialization
//  gBusinessWorkerManager.RegisteWorker(TClientBusinessWechat);
  gBusinessWorkerManager.RegisteWorker(TClientBusinessWechat, sPlug_ModuleBus);
end.

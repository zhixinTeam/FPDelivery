...
const
  ...
  cFI_FrameCustomer_FP  = $0018;                     //富平客户管理
  cFI_FormStockItem     = $0019;                     //物料管理
  cFI_FrameAuditTruck   = $1106;                     //审核车辆
  ...
  cFI_FormTestResult    = $1063;                     //化验结果录入
  ...
  cFI_FormPoundAjdust   = $1101;                     //磅单勘误(富平)
  cFI_FormOptions       = $1102;                     //参数选项
  cFI_FormSealNum       = $1103;                     //封签号录入(富平)

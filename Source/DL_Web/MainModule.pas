...
uses
  ...
  uniImageList, uniGUIForm, uniDBGrid, uniGUITypes, uniPageControl, USysConst;

type
  TLoadFactoryStatus = reference to procedure (const nFactory: string);
  //载入运行总揽
  ...
  public
    ...
    //菜单模块
    FFactoryStatus: TUniTabSheet;
    FLoadFactoryStatus: TLoadFactoryStatus;
    //工厂运行总揽

...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Buttons, StrUtils, dxGDIPlusClasses;
...
{$R *.dfm}
uses
  IniFiles, ULibFun, USysConst, USysDB, UMgrPopedom,
...
begin
  ...
  try
    WriteLog(Format(sUserLogin, [Edit_User.Text+' 登录计数器']));
    //write log
...
procedure TfFormLogin.pnl1Click(Sender: TObject);
var nNoShowZhiKa:string;
begin
//  nNoShowZhiKa:= ',''123'',''222'',''2222''';
//  nNoShowZhiKa:= Copy(nNoShowZhiKa, 2, Length(nNoShowZhiKa));
//  ShowMessage(nNoShowZhiKa);
end;
